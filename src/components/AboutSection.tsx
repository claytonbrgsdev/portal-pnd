      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            A PND é uma iniciativa inédita no Brasil que unifica a avaliação de professores para
            ingresso na carreira pública, servindo como critério principal ou complementar em
            seleções públicas.
          </p>
        </div>
